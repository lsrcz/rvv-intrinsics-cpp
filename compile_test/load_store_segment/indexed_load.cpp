...
INDEXED_LOAD_TEST(8, i8, m1, 8, u8, m1);
INDEXED_LOAD_TEST(8, i8, m1, 2, u16, m2);
INDEXED_LOAD_TEST(8, i8, m1, 8, u16, m2);
INDEXED_LOAD_TEST(4, i8, m2, 2, u16, m4);
INDEXED_LOAD_TEST(4, i8, m2, 4, u16, m4);
INDEXED_LOAD_TEST(2, i8, m4, 2, u16, m8);

#if HAS_ZVE64X
INDEXED_LOAD_TEST(8, i8, m1, 2, u64, m8);
INDEXED_LOAD_TEST(8, i8, m1, 8, u64, m8);
INDEXED_LOAD_TEST(16, i64, m4, 2, u8, mf2);
INDEXED_LOAD_TEST(64, i8, mf8, 8, u64, m1);
#endif
#if HAS_ZVFH
INDEXED_LOAD_TEST(16, f16, m1, 2, u16, m1);
#endif
#if HAS_ZVE32F
INDEXED_LOAD_TEST(32, f32, m1, 2, u16, mf2);
#endif
#if HAS_ZVE64D
INDEXED_LOAD_TEST(16, f64, m4, 2, u16, m1);
#endif
